...
import com.codepulse.handlers.CustomSuccessHandler;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests((authorize) ->
                        authorize.requestMatchers("/register/**","/css/**","/images/**","/js/**","/error/**").permitAll()
                                .requestMatchers("/").permitAll()
                                .requestMatchers("/dashboard/**","/dashboard/update/**").hasAuthority("ADMIN")
